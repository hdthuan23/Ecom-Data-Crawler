...
|------|-----------|-------|
| **Global_Brand** | `brand_name` ∈ `global_brands_dict` HOẶC có badge Official Store | Intel, Samsung, Corsair |
...
**Lưu ý:** Trường `is_official` và `is_tiki_trading` được lưu riêng, cho phép bạn tùy chỉnh lại phân loại trong giai đoạn phân tích nếu cần.
...
## Schema dữ liệu (15 trường + metadata)
...
| `is_official` | INT | 1=Official Store, 0=Không |
...
- **CSV File:** `data/tiki_electronics_2026_clean.csv` - Import vào Excel/Tableau/PowerBI
